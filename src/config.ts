...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "玩机指北",
			url: "/archive/?category=玩机指北",
			icon: "material-symbols:google-home-devices",
		},
		{
			name: "My",
			url: "/",
...
export const profileConfig: ProfileConfig = {
	avatar: "https://s21.ax1x.com/2025/03/27/pEDOOde.jpg", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "孔大夫",
	bio: "热爱互联网的一切.",
	typewriter: {
...
export const announcementConfig: AnnouncementConfig = {
	title: "展墙", // 公告标题，填空使用i18n字符串Key.announcement
	content: "公告", // 公告内容
...
export const sidebarLayoutConfig: SidebarLayoutConfig = {
	...
	// 侧栏组件布局配置
	components: {
		left: ["profile", "announcement", "tags", "categories", "site-stats"],
